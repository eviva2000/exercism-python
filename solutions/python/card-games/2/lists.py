...
def get_rounds(number):
    ...
    """
    test_round=[number,number+1,number+2]
    return test_round
...
def approx_average_is_average(hand):
    ...
    first_and_second_average=(hand[0]+hand[-1])/2
    median_index=len(hand)// 2
    median_average=hand[median_index]

    return average==first_and_second_average or average==median_average
...
def average_even_is_average_odd(hand):
    ...
    even_items=hand[0::2]
    odd_items=hand[1::2]
    even_items_average=card_average(even_items)
    odd_items_average=card_average(odd_items)
    if even_items_average==odd_items_average:
        return True
    return False
