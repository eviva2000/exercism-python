...
def value_of_ace(card_one, card_two):
    ...
    total_value_of_first_two_cards=value1+value2
    if total_value_of_first_two_cards + 11 <= 21:
        return 11
    return 1
...
def is_blackjack(card_one, card_two):
    ...
    ten_cards={'J','Q','K','10'}
    if (card_one in ten_cards or card_two in ten_cards) and (card_one=='A' or card_two=='A'):
        return True
    return False
...
def can_double_down(card_one, card_two):
    ...
    value2=value_of_card(card_two)
    total=value1+value2
    allowed_total={9,10,11}
    if total in allowed_total:
        return True
    return False
